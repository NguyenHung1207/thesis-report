...
\hline
Tái sử dụng test case và kịch bản kiểm thử & Lưu test case, test data, test suite, replay script, object repository và evidence để dùng lại trong các lần kiểm thử sau. & 110/167 lần chạy tạo được replay script hoặc được đánh dấu reusable, tương ứng 65.9\%; đây là chỉ số về khả năng tái sử dụng tiềm năng trong phạm vi case study. \\
\hline
