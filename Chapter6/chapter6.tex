...
Trong các phiên thực thi thất bại, một phần lỗi được hệ thống phân loại rõ ràng trong failure analysis. Do số lượng lỗi đã phân loại còn thấp, Bảng~\ref{tab:chapter6_failure_analysis} trình bày đồng thời số lượng và tỷ lệ theo loại lỗi để minh bạch dữ liệu nhưng vẫn chỉ xem đây là quan sát xu hướng.
...
Bên cạnh phân loại lỗi theo run, hệ thống còn ghi nhận thông tin về các step thất bại. Do số lượng step lỗi được ghi nhận còn thấp, Bảng~\ref{tab:chapter6_step_failure_action} trình bày đồng thời số lượng và tỷ lệ theo loại hành động để minh bạch dữ liệu nhưng vẫn chỉ xem đây là quan sát xu hướng.
