...
Trong mô hình trên, \texttt{projects} là thực thể gốc để gom nhóm dữ liệu. \texttt{test\_cases} và \texttt{test\_case\_versions} mô tả nội dung kiểm thử; \texttt{execution\_scripts} lưu replay script; còn \texttt{test\_runs}, \texttt{run\_step\_logs} và \texttt{evidences} lưu quá trình thực thi.
