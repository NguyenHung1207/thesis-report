...
Sự phát triển của các mô hình ngôn ngữ lớn (Large Language Models - LLM) mở ra khả năng hỗ trợ tự động sinh test case và test data từ yêu cầu bằng ngôn ngữ tự nhiên. Tuy nhiên, nếu mỗi lần kiểm thử hoặc mỗi lần phát hành phiên bản mới đều phụ thuộc hoàn toàn vào LLM hoặc AI Agent để sinh lại toàn bộ kịch bản kiểm thử thì chi phí sử dụng mô hình, thời gian thực thi và tính ổn định của hệ thống sẽ bị ảnh hưởng.
...
Ở các phiên bản phần mềm tiếp theo, nếu luồng nghiệp vụ không thay đổi đáng kể, hệ thống ưu tiên tái sử dụng các automation test script đã có để thực hiện kiểm thử hồi quy thay vì sinh lại bằng mô hình ngôn ngữ lớn. Chỉ khi các thay đổi của hệ thống vượt quá khả năng tái sử dụng, tester mới cần sử dụng AI để tạo mới hoặc cập nhật test script.

Cách tiếp cận này giúp giảm thời gian xây dựng automation test, giảm chi phí sử dụng mô hình ngôn ngữ lớn, đồng thời tăng khả năng tái sử dụng và bảo trì các kịch bản kiểm thử trong quá trình phát triển phần mềm.
...
\begin{itemize}
    ...
    \item Xây dựng quy trình hỗ trợ giảm thời gian tạo automation test và giảm chi phí bảo trì test script trong quá trình phát triển phần mềm.
\end{itemize}

Nhìn chung, hệ thống đã hiện thực được quy trình hỗ trợ tester từ giai đoạn phân tích yêu cầu, sinh test case, sinh automation test script, xác nhận kết quả đến tái sử dụng các script trong các phiên bản tiếp theo. Qua đó góp phần giảm thời gian xây dựng kiểm thử tự động và nâng cao hiệu quả kiểm thử hồi quy.
...
Chương 6 trình bày thực nghiệm và đánh giá hệ thống thông qua các kịch bản kiểm thử trên website mẫu, đồng thời đánh giá hiệu quả về thời gian tạo test case, test script và khả năng tái sử dụng trong kiểm thử hồi quy.
