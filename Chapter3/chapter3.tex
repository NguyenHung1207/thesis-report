...
Trong các lần kiểm thử hồi quy tiếp theo, hệ thống ưu tiên chạy replay script bằng Playwright mà không cần mô hình ngôn ngữ lớn suy luận lại ở từng bước. Agent được sử dụng chủ yếu để tạo script ban đầu hoặc tạo lại script khi website thay đổi đáng kể.
...
NFR04 &
Tối ưu chi phí &
Ưu tiên replay script cho kiểm thử hồi quy nhằm giảm số lần gọi LLM và chi phí sử dụng mô hình. \\
\hline
...
Đối với các test case đã có replay script, hệ thống ưu tiên chế độ replay trong các lần kiểm thử hồi quy. Tester có thể quản lý test suite mà không bắt buộc phải thực hiện test run ngay lập tức.
...
Trong các lần kiểm thử hồi quy tiếp theo, hệ thống ưu tiên tái sử dụng replay script thay vì yêu cầu LLM suy luận lại ở từng bước. Cách tiếp cận này giúp giảm công sức xây dựng kịch bản ban đầu, giảm số lần gọi mô hình và tăng khả năng tái sử dụng test script.
